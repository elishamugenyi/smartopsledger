...
import { createCheckoutClient } from "usebilling/client";
import type { Plan, PriceInterval } from "usebilling";
        ...
        <div className="snw-pricing-grid">
          {plans.map((plan) => {
            ...
            return (
              ...
              >
                {isCurrent && (
                  <span className="snw-current-badge">Current Plan</span>
                )}
                  ...
                  <ul className="snw-plan-features">
                    {Object.entries(plan.credits).map(([type, config]) => (
                      <li key={type} className="snw-plan-feature">
                        {config.allocation.toLocaleString()}{" "}
                ...
                {isCurrent ? (
                  ...
                  >
                    {isManageLoading && (
                      <span className="snw-loading-spinner" />
                    )}
                    Manage Subscription
                  </button>
                ) : (
